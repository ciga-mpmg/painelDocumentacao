...
O banco de dados `aecom_ciga_homolog` contém as principais tabelas utilizadas pelo Painel Gerencial CIGA. Ele é utilizado para armazenar informações sobre recomendações, barragens, complexos minerários e metadados de diversos artefatos utilizados pelos painéis.
