...
### Repositórios que utilizam o banco de dados
...
[TEMPORÁRIO] Tabelas que faltam descrever: 

```{r}
tabelas_descritas <- c("geography_columns", "geometry_columns", "pg_stat_statements", "pg_stat_statements_info", "spatial_ref_sys", "comarcasTJMG")

tabelas_para_descrever <- setdiff(tabelas_no_bd_reco, tabelas_descritas)

tabelas_para_descrever |>
  sort() |>
  writeLines()
```
...
-   `comarcasTJMG`:
    ...
    - **Leitura:** [painelEmailsSIGBM](https://github.com/ciga-mpmg/painelEmailsSIGBM), [scraper_sigbm](https://github.com/ciga-mpmg/scraper_sigbm), [resuvafeca](https://github.com/ciga-mpmg/resuvafeca).

-   `recommendations3`: 
    - **Descrição:** Tabela de recomendações emitidas por auditorias.
    - **Criação:** ETL feito no repositório [resuvafeca](https://github.com/ciga-mpmg/resuvafeca).
    - **Leitura:** ...
